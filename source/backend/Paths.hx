...
class Paths
{
	...
	inline static public function soundEmbed(key:String, ?modsAllowed:Bool = true) //Я ГЕНМЙ СУКА
		return FlxAssets.getSound('flixel/sounds/$key');
	...
	public static function cacheBitmap(key:String, ?parentFolder:String = null, ?bitmap:BitmapData, ?allowGPU:Bool = true):FlxGraphic
	{
		if (bitmap == null)
		{
			...
			if (bitmap == null)
			{
				trace('oh no its returning null NOOOO: $file | key: $key');
				return null;
			}
		}
