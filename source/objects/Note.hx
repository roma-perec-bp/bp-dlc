		...
		if(noteData > -1 && noteType != value) {
			switch(value) {
				...
				case 'JACK NOTE':
					switch(noteData)
					{
						case 0:
							rgbShader.r = 0xFF000000;
							rgbShader.g = 0xFFFFFFFF;
							rgbShader.b = 0xffff006d;
						case 1:
							rgbShader.r = 0xFF000000;
							rgbShader.g = 0xFFFFFFFF;
							rgbShader.b = 0xff49ceaa;
						case 2:
							rgbShader.r = 0xFF000000;
							rgbShader.g = 0xFFFFFFFF;
							rgbShader.b = 0xff848b9e;
						case 3:
							rgbShader.r = 0xFF000000;
							rgbShader.g = 0xFFFFFFFF;
							rgbShader.b = 0xff81b489;
					}
				case 'JACK NOTE ALT':
					switch(noteData)
					{
				...
				case 'JACK NOTE NO ANIM':
					...
					noAnimation = true;
					noMissAnimation = true;
				case 'BEATUS PEREC' | 'BEATUS POLE' | 'BEATUS ALL':
					switch(noteData)
					{
						case 0:
							rgbShader.r = 0xFF000000;
