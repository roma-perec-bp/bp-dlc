...
class FunkinLua {
	...
	public function new(scriptName:String) {
		...
		@:privateAccess
		{
			...
			set('respawnPoint', PlayState.respawnPoint);
			...
			for (i in 0...4) {
				...
				set('InitDefaultPlayerStrumX' + i, 0);
				set('InitDefaultPlayerStrumY' + i, 0);
				set('InitDefaultOpponentStrumX' + i, 0);
				set('InitDefaultOpponentStrumY' + i, 0);
			}
