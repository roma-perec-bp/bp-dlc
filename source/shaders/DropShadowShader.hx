...
class DropShadowShader extends FlxShader
{
   ...
   */
  public var colorGay(default, set):FlxColor;
  ...
  function set_colorGay(col:FlxColor):FlxColor
  {
    colorGay = col;
    dropColor.value = [colorGay.red / 255, colorGay.green / 255, colorGay.blue / 255];
  ...
  public function loadAltMask(path:String)
  {
    ...
    #else
    //altMaskImage = funkin.NativeFileSystem.getBitmap(path);
    #end
  }
